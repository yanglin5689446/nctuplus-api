...
ActiveRecord::Schema.define(version: 20180803090706) do
  ...
  create_table "timetables_courses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer  "timetable_id"
    t.integer  "course_id"
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["course_id"], name: "index_timetables_courses_on_course_id", using: :btree
    t.index ["timetable_id"], name: "index_timetables_courses_on_timetable_id", using: :btree
  end
